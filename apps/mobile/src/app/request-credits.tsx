...
const METHOD_BLURB: Record<Method, string> = {
  instapay:
    "Transfer the amount to the academy's InstaPay account, then submit this request with a screenshot of your transfer.",
      ...
      <Card>
        ...
        {method === 'instapay' ? (
          <View style={styles.payee}>
            ...
            {/* PLACEHOLDER — the academy fills in its real InstaPay payee before launch. */}
            <Text variant="body" weight="bold">
              [InstaPay account — to be provided by the academy]
            </Text>
          </View>
        ) : null}
      </Card>
